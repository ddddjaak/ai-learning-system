...
<div class="path-finder" markdown="1">

<p>选择你的角色，获取个性化学习路径推荐：</p>

<div class="path-finder-buttons">
  <button data-role="ae" class="md-button md-button--primary">
    💻 我是 AE / 嵌入式工程师
  </button>
  <button data-role="se" class="md-button md-button--primary">
    📋 我是 SE / 系统工程师
  </button>
  <button data-role="new" class="md-button md-button--primary">
    🚀 我还不确定 / 刚接触
  </button>
</div>

<div class="path-result" style="display:none;">
  <div data-result="ae" style="display:none;">
    <h4>✅ 推荐路径</h4>
  ...
  <div data-result="se" style="display:none;">
    <h4>✅ 推荐路径</h4>
  ...
  <div data-result="new" style="display:none;">
    <h4>✅ 推荐路径</h4>
