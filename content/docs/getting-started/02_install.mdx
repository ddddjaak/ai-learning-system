...
![截图：CC Switch GitHub Releases 下载页面](#)
...
>
> ![截图：CC Switch MCP 管理界面](#)
>
> ![截图：CC Switch Skills 管理界面](#)
>
> ![截图：CC Switch 会话管理界面](#)
>
> ![截图：CC Switch 提示词管理界面](#)
...
![截图：编辑供应商基本设置——Base URL、API Key、主力模型](#)
...
![截图：编辑供应商高级选项——API格式、认证字段、模型映射、上下文窗口、兜底模型](#)
...
![截图：CC Switch 编辑通用配置——settings.json 编辑界面](#)
